...
const Home = () => {
    const { setActiveHeader } = useContext(ProjectsContext)
    
    return (
        <div className='flex w-full h-screen justify-center items-center md:p-[70px] p-[10px] mt-10'>
            <div className='flex-col-reverse flex md:flex md:flex-row md:w-[80%] w-[100%] justify-center md:rounded-br-[100px] md:rounded-tr-[100px] items-center p-5 bg-gradient-to-br from-pink-300 to-[#030eee]'>
                <div className='flex flex-col gap-2 '>
                    ...
                    <p className='text-white text-xl'>I am a skilled and passionate web/mobile React developer with experience in creating beautiful, responsive and functional app</p>
                    <Link to='/portfolio' >
